...
SERVICES = {
    "General": [0x0020, 0x0021, 0x0022, 0x0023],
    "Analog": [0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035],
    "Digital": [0x0040, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047, 0x0048]
}
...
class MainWindow(QMainWindow):
    ...
    def update_value(self, uuid, val):
        if uuid in self.fields:
            ...
            analog_uuids = [UUID_BASE.format(0x0030),
                            UUID_BASE.format(0x0031),
                            UUID_BASE.format(0x0032),
                            UUID_BASE.format(0x0033),
                            UUID_BASE.format(0x0034),
